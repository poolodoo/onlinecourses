...
class ListthethreemusketeersItemWidget extends StatelessWidget {
  ListthethreemusketeersItemWidget(this.listthethreemusketeersItemModelObj);

  ListthethreemusketeersItemModel listthethreemusketeersItemModelObj;
