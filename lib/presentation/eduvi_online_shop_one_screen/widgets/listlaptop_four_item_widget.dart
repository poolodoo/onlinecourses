...
class ListlaptopFourItemWidget extends StatelessWidget {
  ListlaptopFourItemWidget(this.listlaptopFourItemModelObj);

  ListlaptopFourItemModel listlaptopFourItemModelObj;
